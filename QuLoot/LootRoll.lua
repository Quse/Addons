...
local texture = "Interface\\AddOns\\SharedMedia\\statusbar\\statusbar"

local backdrop = {
	bgFile = "Interface\\AddOns\\SharedMedia\\statusbar\\statusbar", tile = true, tileSize = 0,
...
label:SetFont(font, fontsize, fontflag)
...
local function START_LOOT_ROLL(rollid, time)
	...
	f:SetPoint("CENTER", WorldFrame, "TOP", 0, -200)
	f:Show()
end
