...
oUF.Tags.Methods['freebgrid:es'] = function(u) 
    local name, _,_,_,_,_,_, fromwho = UnitAura(u, GetSpellInfo(974)) -- ¼¤Á÷
...
-- Paladin ÆïÊ¿
oUF.Tags.Methods['freebgrid:EFlame'] = function(u) --¼¤Á÷
...
oUF.Tags.Methods['freebgrid:SS'] = function(u) --¼¤Á÷
...
oUF.Tags.Methods['freebgrid:beacon'] = function(u) if UnitAura(u, GetSpellInfo(53563)) then return "|cffFFB90F"..x.."|r" end end --µÀ±ê
