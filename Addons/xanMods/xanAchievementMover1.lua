...
function f:DrawAnchor()
	...
	frame:SetBackdropColor(0.15, 0.49, 1, 0)
	frame:SetBackdropBorderColor(0.15, 0.49, 1, 0)
	...
	frameAch1:SetPoint("CENTER", xanAchievementMover_Anchor, "BOTTOM", 0, -(frame:GetHeight()/2 - 8) )
	...
	frameAch1:SetBackdropColor(153/255, 204/255, 51/255, 0)
	frameAch1:SetBackdropBorderColor(153/255, 204/255, 51/255, 0)
	...
	frameAch2:SetPoint("TOPLEFT", frameAch1, "BOTTOMLEFT", 0, 19)
	...
	frameAch2:SetBackdropColor(153/255, 204/255, 51/255, 0)
	frameAch2:SetBackdropBorderColor(153/255, 204/255, 51/255, 0)
